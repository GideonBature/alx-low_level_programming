...
## Project Tasks
## 0. Multiple mains
**Description:** In most projects, we often give you only one main file to test with. For example, this main file is a test for a postitive_or_negative() function similar to the one you worked with in an earlier C project:
```
...
Directory: `0x03-debugging` <br>
File: `0-main.c`, `main.h` <br>
...
GitHub repository: `alx-low_level_programming` <br>
Directory: `0x03-debugging` <br>
File: `2-largest_number.c`, `main.h` <br>
...
GitHub repository: `alx-low_level_programming` <br>
Directory: `0x03-debugging` <br>
File: `3-print_remaining_days.c`, `main.h` <br>
