...
Directory: `0x0F-function_pointers` <br>
File: `0-print_name.c` <br>
...
GitHub repository: `alx-low_level_programming` <br>
Directory: `0x0F-function_pointers` <br>
File: `3-main.c, 3-op_functions.c, 3-get_op_func.c, 3-calc.h` <br>
...
**Description:** Write a program that prints the [opcodes](https://en.wikipedia.org/wiki/Opcode) of its own main function.
